...
# download all
gsutil cp gs://ukbb-gwas-results/ldsc_results/ukbb18597_h2part_results.batch_* ./
...
# download all
gsutil cp gs://ukbb-gwas-results/ldsc_results/ukbb11898_icd10_h2part_results.batch_* ./
...
zless ukbb18597_h2part_results.labeled.tsv.gz | gzip -c > ukbb_all_h2part_results.txt.gz
zless ukbb11898_icd10_h2part_results.labeled.tsv.gz | tail -n +2 | gzip -c >> ukbb_all_h2part_results.txt.gz
