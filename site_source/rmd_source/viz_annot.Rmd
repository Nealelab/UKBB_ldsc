---
title: "Partitioned SNP-Annotations"
...
d3m <- melt(d3[,c(1,2,4,8:11,12:42)],c("phenotype","description","h2_liability","h2_p","intercept","intercept_p","Neff"),value.name="pval", variable.name="var2")
...
d3m <- melt(d3[,c(1,2,4,8:11,12:18)],c("phenotype","description","h2_liability","h2_p","intercept","intercept_p","Neff"),value.name="pval", variable.name="var2")
d3m$annot <- gsub("..Coefficient_p","",d3m$var2)
foo <- aggregate(pval~annot,data=d3m,min)
d3m$annot <- factor(d3m$annot, levels = foo$annot[order(foo$pval)])
d3bm$annot <- factor(d3bm$annot, levels = foo$annot[order(foo$pval)])
