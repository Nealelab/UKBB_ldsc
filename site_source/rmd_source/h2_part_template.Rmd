...
Download the full LDSR results for this phenotype (along with all of the other GWASed phenotypes), including SNP heritability and partitioning results, from the [downloads page](downloads.html).
