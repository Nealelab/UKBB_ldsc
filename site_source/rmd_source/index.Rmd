...
Yes! You can browse genetic correlations between the significantly heritable phenotypes at [https://ukbb-rg.hail.is/](https://ukbb-rg.hail.is/). You can also [download the LDSC-formatted sumstats files](downloads.html#ldsc_sumstat_files) for your own genetic correlation analyses. Round 1 results are also available for genetic correlation analyses through [LD Hub](http://ldsc.broadinstitute.org/).
