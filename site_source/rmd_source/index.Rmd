...
Yes! You can browse genetic correlations between the significantly heritable phenotypes at [https://ukbb-rg.hail.is/](https://ukbb-rg.hail.is/). Round 1 results are also available for genetic correlation analyses through [LD Hub](http://ldsc.broadinstitute.org/).
