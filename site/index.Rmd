...
<a href="https://www.dropbox.com/sh/g28ee03vy4hvqw5/AADAkDbSFHsYE8bme1Jjeekca/ldsc_results?dl=0" class="btn btn-primary btn-lg">Download Results</a>
...
We’ve created a browser to explore the results [here](h2_browser.html). You can also download the full results file [here](https://www.dropbox.com/sh/g28ee03vy4hvqw5/AADAkDbSFHsYE8bme1Jjeekca/ldsc_results?dl=0).
...
Yes! Results will be available for browsing through the [Global Biobank Engine](https://biobankengine.stanford.edu/), and the full GWAS results are available for download from [here](https://www.dropbox.com/sh/g28ee03vy4hvqw5/AAAGunSi-VK-0cUqvcwyt67ra/associations?dl=0). See [the introductory post](http://www.nealelab.is/blog/2017/7/19/rapid-gwas-of-thousands-of-phenotypes-for-480000-samples-in-the-uk-biobank) for much more information. 
