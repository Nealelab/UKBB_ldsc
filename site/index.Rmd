...
Yes! Parial results are available for browsing through the [Global Biobank Engine](`link`), and the full GWAS results are available for bulk download from [here](`link`). See [the introductory post](`link`) for much more information. 
