...
renderUI({
	...
	ukb_url = a("Find this phenotype on the UK Biobank Showcase (numeric codes only, excluding ICD)", href=paste0("http://biobank.ctsu.ox.ac.uk/crystal/search.cgi?srch=",phenstem))
